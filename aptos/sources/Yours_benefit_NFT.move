...
module mint_nft::Yours_benefit_NFT {
    use std::error;
    use std::string;
    use std::vector;
    ...
    fun init_module(resource_signer: &signer) {
        let collection_name = string::utf8(b"yours");
        let description = string::utf8(b"This is yours collection");
        let collection_uri = string::utf8(b"https://gateway.pinata.cloud/ipfs/QmThC8rPrcEVjBAkQ5foozo9th5YZqQ13atBZpUMfPjPit");
        let token_name = string::utf8(b"yours nft");
        let token_uri = string::utf8(b"https://gateway.pinata.cloud/ipfs/QmdKVWBc1TaVMSi2uDjpVhvvUbtT1sTrKmsDXRDtCwN9mD");
        let benefit_uri = string::utf8(b"");
        let benefits = vector::empty<u64>();
    ...
    public entry fun mint_yours_nft(receiver: &signer) acquires ModuleData {
